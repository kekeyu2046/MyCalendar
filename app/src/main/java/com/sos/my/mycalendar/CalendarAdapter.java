...
public class CalendarAdapter extends BaseAdapter {
	...
	private ArrayList<Integer> rangeDate = null;//受限日期范围角标
	...
	public CalendarAdapter(Context context, Resources rs, int jumpMonth, int jumpYear, int year_c, int month_c, int day_c, String startDate, String endDate, String selectDay){
		this();
	...
	public View getView(int position, View convertView, ViewGroup parent) {
		...
		int firstDayIndex = dayOfWeek == 0 ? (7-1) :(dayOfWeek - 1);
